...
ProductController.store = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const product = yield createProduct_service_1.default.execute({ category, description, name, price });
...
ProductController.update = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = request.params;
    const updatedProduct = yield updateProduct_service_1.default.execute({ id, name, price, description, category });
