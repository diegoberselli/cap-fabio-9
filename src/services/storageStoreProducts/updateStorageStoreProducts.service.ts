import { IUpdateStorateStoreProductUpdate } from "./../../interfaces/storageStoreProducts/index";
import { AppDataSource } from "../../data-source";
import { Storage } from "../../entities/storageStoreProducts";
import { AppError } from "../../errors/AppError";

export default class UpdateStorageStoreProductService {
  static execute = async ({ id, storage_quantity }: IUpdateStorateStoreProductUpdate) => {
